...
from sim.mahasiswa.forms import mahasiswa_F, loginmahasiswa_F, editmahasiswa_F, pengaduan_F
...
def edit_mahasiswa():
	...
	if form.validate_on_submit():
		...
		current_user.password=pash_hash
		db.session.commit()
...
def update(ed_id):
	if request.method == 'POST':
		...
		my_data.kategori = request.form['kategori']
